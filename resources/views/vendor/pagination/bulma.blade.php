...
<nav class="pagination is-centered" role="navigation" aria-label="pagination">
    ...
    @else
    <a class="pagination-previous" href="{{ $paginator->previousPageUrl() }}">Sebelumnya</a>
    @endif

    {{-- Next Page Link --}}
    @if ($paginator->hasMorePages())
    <a class="pagination-next" href="{{ $paginator->nextPageUrl() }}">Selanjutnya</a>
    @else
    <a class="pagination-next" disabled>Selanjutnya</a>
    @endif
